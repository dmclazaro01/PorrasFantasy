-- ============================================================
-- Porra Fantasy · 0031 · Ventana de juego de la DUPLA
-- ============================================================
-- La DUPLA ya no exige jornada sin empezar: se puede jugar mientras se
-- hayan jugado 5 partidos o menos de la jornada (FINISHED estrictos;
-- aplazados no cuentan). Sigue valiendo: un solo dúo por jugador y
-- jornada (ni como creador ni como objetivo), con lo que el reparto a
-- 3 bandas es imposible: el segundo intento se rechaza al jugarse (y el
-- resolutor lo ignoraría por orden de juego).
-- ============================================================
...
declare
  c porra.cards; m porra.matches; my_points int; round_started boolean; played_count int;
begin
  ...
  if c.type = 'CANCHERO' then
    -- Solo antes de empezar la jornada, con protagonista.
