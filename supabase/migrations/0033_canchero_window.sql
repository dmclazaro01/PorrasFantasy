-- ============================================================
-- Porra Fantasy · 0033 · Ventana de juego del CANCHERO
-- ============================================================
-- El CANCHERO se puede jugar mientras hayan empezado menos de 2
-- partidos de la jornada (o sea, hasta el comienzo del segundo).
-- Motivo: jornadas que arrancan antes de existir en la app (un partido
-- adelantado) no deben bloquear la carta toda la semana. La DUPLA ya
-- tiene su propia ventana (0031: 5 jugados o menos).
-- ============================================================
...
begin
  ...
  if c.type = 'CANCHERO' then
    -- Con protagonista, hasta el comienzo del segundo partido.
